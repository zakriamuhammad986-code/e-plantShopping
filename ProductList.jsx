...
export default function ProductList() {
  ...
  const handleAddToCart = (plant) => {
    dispatch(addItem({ id: plant.id, name: plant.name, price: plant.price, image: plant.image }));
  };
  ...
  return (
    <main className="product-list">
      <div className="product-list-intro">
        <h1>Our Plants</h1>
        <p>Every plant below is greenhouse-raised and ready to ship this week.</p>
      </div>
